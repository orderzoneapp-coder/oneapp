...
assert.match(input, /vNext 0\.5\.1/);
assert.match(input, /orderq-db\.js\?v=0\.5\.1|order-intake-engine\.js\?v=0\.5\.1/,
  'IndexedDB v5 화면은 이전 캐시 모듈과 섞이지 않도록 릴리스 쿼리를 사용해야 한다.');
