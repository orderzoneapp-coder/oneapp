...
const workspace={schemaVersion:'shipping-workspace/v2',basisDateStatus:'valid',uploadDate:'20260825',basisDate:'2026-08-25',basisDates:['2026-08-25'],createdAt:'2026-08-25T00:00:00.000Z',planId:'PLAN1',sourceFingerprint:'FP1',purchaseManagement:[
  {rowType:'main',inventoryMatched:true,productCode:'A',productName:'상품A',specification:'',purchaseNeed:2,purchase:'남경',unit:'BOX',baseUnit:'EA',unitConversionFactor:10,baseQuantity:20,unitConversionSource:'PRODUCT_MASTER',productId:'P1',productMasterRevision:2,supplierCustomerId:'C1',supplierCustomerCode:'S1',warehouseId:'W1',warehouseCode:'01',warehouseMasterRevision:1,sourceShortageKey:'SHORT-1',externalDocumentNo:'EXT-1'},
  {rowType:'main',inventoryMatched:true,productCode:'B',productName:'상품B',specification:'',purchaseNeed:3,purchase:'남경',unit:'EA',baseUnit:'EA',unitConversionFactor:1,productId:'P2',productMasterRevision:3,supplierCustomerId:'C1',supplierCustomerCode:'S1',warehouseId:'W1',warehouseCode:'01',warehouseMasterRevision:1,sourceShortageKey:'SHORT-2',externalDocumentNo:'EXT-2'}
]};
...
assert.deepEqual(meta.map(row=>row.sourceShortageKey),['SHORT-1','SHORT-2']);
