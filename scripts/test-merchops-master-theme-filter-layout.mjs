...
const versionMatches = [...html.matchAll(/v2\.1\.195_ProductRegistration/g)];
assert.ok(versionMatches.length >= 2, "all visible MerchOps version labels must use v2.1.195");
