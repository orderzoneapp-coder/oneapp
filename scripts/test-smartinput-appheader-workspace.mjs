...
assert.match(html, /href="\.\/smartinput\.css\?v=0\.9\.11"/, 'the estimate touch-target CSS must use the next cache-bust version');
assert.match(html, /src="\.\/smartinput\.js\?v=0\.11\.39"/, 'the match-dictionary and upload-sort route must use the next cache-bust version');
