...
assert.match(html, /href="\.\/smartinput\.css\?v=0\.9\.10"/, 'the estimate touch-target CSS must use the next cache-bust version');
assert.match(html, /src="\.\/smartinput\.js\?v=0\.11\.35"/, 'the early estimate-panel interaction must use the next cache-bust version');
