...
assert.match(html, /href="\.\/smartinput\.css\?v=0\.9\.17"/, 'the F8 recovery UI CSS must use the next cache-bust version');
assert.match(html, /src="\.\/smartinput\.js\?v=0\.11\.49"/, 'the F8 recovery route must use the next cache-bust version');
