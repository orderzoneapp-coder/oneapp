...
> 2026-09-13 후속 3영역 재구축에서 런타임 조립 파일과 이 버전 전용 검사는 고정 초기 마크업·다중 문서 계약으로 대체되었다. 현재 작업·배포·복구 기준은 `ORDEROPS_THREE_AREA_20260913_WORK_RECORD.md`를 따른다. 이 문서는 선행 배포 기록으로 보존한다.
