(() => {
  ...
  const APPS = Object.freeze([
    ...
    Object.freeze({ id: 'customer-master', label: '거래처관리', detail: '거래처 기준정보 조회·관리', path: '/customer-master/index.html' }),
    Object.freeze({ id: 'merchops', label: '가격·시세', detail: '가격·상품 운영', path: '/MerchOps.html' }),
    Object.freeze({ id: 'smart-input', label: '스마트입력', detail: '전표 작성 작업', path: '/smartinput/index.html' }),
