(() => {
  ...
  window.NEXUS_GROUPS = freezeRecords([
    ...
    { id: 'shipping', name: '주문·출고', section: 'operations', url: `${base}/orderops/list.html`, logo: logoSlot('shipping') },
    { id: 'inventory', name: '재고·정산', section: 'operations', url: `${base}/DataOps.html`, logo: logoSlot('inventory') },
  ]);

  window.NEXUS_APPS = freezeRecords([
    { id: 'orderq', groupId: 'shipping', name: 'ORDER Q vNext', description: '주문·출고 작업', url: `${base}/orderq/index.html`, lifecycle: 'operational', access: 'allowed' },
