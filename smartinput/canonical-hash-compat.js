(function canonicalHashCompat(root) {
  'use strict';
  ...
  root.ORDERQ_CANONICAL_HASH = Object.freeze({ canonicalJson, canonicalSha256: value => sha256Text(canonicalJson(value)), canonicalValue, normalizeNumber, normalizeText, sha256Text });
})(globalThis);
