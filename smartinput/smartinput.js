...
function renderDelivery() {
  ...
  $('completeButton').disabled = (!isOrder && !isEstimate && !(isPurchase && state.purchaseCapability.ready) && !(isSale && state.saleCapability.ready)) || state.busy || !referencesReady();
...
function downloadMinimumUploadTemplate() {
