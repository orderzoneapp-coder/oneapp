import { loadWarehouseCatalog } from './legacy-integration-adapter.js?v=0.3.2';
import { loadFieldDefinitions, loadSettingValue } from './smartinput-data-store.js?v=0.7.0';
import { ensureFieldCatalogSeed } from './field-registry.js?v=0.2.0';
