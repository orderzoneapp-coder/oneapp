...
vNext 0.4.1 stabilizes `/orderq/collector.html`. Historical imports never create operational orders. They are stored in source-preserving import batches, normalized transaction ledgers, fulfillment links, net fulfillment balances, and lifecycle-managed parser evidence.
