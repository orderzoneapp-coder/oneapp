...
function normalizeLine(source = {}) {
  const {
    ...
    customerNotifiedBy: _customerNotifiedBy,
    customerNotifiedAt: _customerNotifiedAt,
  ...
  return {
    ...
    actualProductReferenceUnitPriceWon: optionalNumber(source.actualProductReferenceUnitPriceWon ?? source.actualProductUnitPriceWon),
    actualProductUnitPriceWon: optionalNumber(source.actualProductReferenceUnitPriceWon ?? source.actualProductUnitPriceWon),
    manualUnitPriceWon: optionalNumber(source.manualUnitPriceWon),
    appliedUnitPriceWon: optionalNumber(source.appliedUnitPriceWon),
    priceChangedFromOrder: Boolean(source.priceChangedFromOrder ?? source.priceChanged),
    priceChanged: Boolean(source.priceChangedFromOrder ?? source.priceChanged),
