...
- OrderOps 앱헤더는 주문·재고·발주·구매·판매·수불 현황 전환과 출고분석·초기화·설정을 소유한다. 검색·필터·정렬·열 설정은 중앙 상단, 저장 상태/F8은 중앙 하단 왼쪽, 자료 불러오기·출고확정·F9/F10·다음 작업은 하단 오른쪽에 둔다. 파일은 왼쪽 준비에서 유형·시트·헤더·시작행·열을 검증한 후 명시 적용한다. 원본 소유권·단축키·출력 양식은 배치 변경으로 바꾸지 않는다.
