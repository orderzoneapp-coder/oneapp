...
- Architecture document version: 2.3.7
...
- Runtime verification: 7개 앱의 일반/다크 헤더와 공통 표 표시·순백색 인쇄 계약, 6개 작업영역의 독립 폭 조절·상태 보존, OrderOps 분석 전 저장·복구·동일 부모 3개 섹션·좌측 파서 내부 Excel/API 준비와 보조 복구 메뉴·중앙 작업 전용 하단바·우측 전표 날짜/금액/적요 및 선택 합계·다중 주문 Revision 조정·저장 실패 재시도와 재진입을 실제 브라우저에서 검증하며 운영 배포 버전은 CI와 Pages에서 별도 대조
