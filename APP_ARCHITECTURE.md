...
- Architecture document version: 2.2.3
...
- Review scope: 규범·아키텍처·작업배분의 경계 및 관련 문구 정합성
- Runtime verification: 이번 문서 개정에서는 수행하지 않음
